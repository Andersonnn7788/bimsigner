...
es_callback = EarlyStopping(monitor="val_loss", patience=75, restore_best_weights=True, min_delta=0.001)
...
model.fit(X_train, y_train, epochs=2000, validation_split=0.2,
          callbacks=[tb_callback, es_callback], class_weight=class_weight_dict)
