...
def extract_keypoints(results):
    """Flatten MediaPipe Holistic landmarks into a 1662-dim numpy array.

    Breakdown: pose (33×4=132) + face (468×3=1404) + left hand (21×3=63) + right hand (21×3=63)
    """
    pose = (
...
def draw_styled_landmarks(image, results):
    """Draw colored MediaPipe landmarks on a frame."""
    # Face
